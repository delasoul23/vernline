...
export class CustomerResolverBase {
  ...
  async createCustomer(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        allPurchases: args.data.allPurchases
          ? {
              connect: args.data.allPurchases,
            }
          : undefined,
      },
    });
  ...
  async allPurchases(@graphql.Parent() parent: Customer): Promise<Item | null> {
    const result = await this.service.getAllPurchases(parent.id);
